...
<div id="index_all">
	<div id="reportcenter_all">
        ...
        <textarea   style="width:800px; height:200px; border:1px solid;  color:#999; font-size:28px;" name="content" ><%=article.getIntroduction()%></textarea>
        </div>
       ...
       <script type="text/javascript">
        ...
        <input type="hidden"  name="author_id" value="<%=user.getId()%>"> 
         <input type="hidden"  name="username" value="<%=article.getAuthor()%>"> 
         <input type="hidden"  name="user_id" value="<%=article.getAuthor_id()%>"> 
        <input type="hidden"  name="type" value="举报文章"> 
        <input type="hidden"  name="article_id" value="<%=article_id%>"> 
        <input type="hidden"  name="content_id" value="<%=article_id%>"> 
