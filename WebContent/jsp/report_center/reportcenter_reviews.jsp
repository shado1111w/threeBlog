...
<div id="index_all">
	<div id="reportcenter_all">
        ...
        <span style="font-size:20px;">&ensp;中发表的评论,摘要如下：&ensp;</span><br/><br/>
        <input type="text" style="width:800px; height:200px; border:1px solid;  color:#999; font-size:28px;" value="丢，*他*的"/>
        </div>
