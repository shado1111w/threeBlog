...
function myfunction(){
	...
	if (id != null) {
		if (id == "1") {
			$('#messagecenter_reviews').load('${pageContext.request.contextPath}/jsp/message_center/messagecenter_reviews.jsp');
		} else if (id == "2") {
			$('#messagecenter_reviews').load('${pageContext.request.contextPath}/jsp/message_center/messagecenter_follow.jsp');
		} else if (id == "3") {
			$('#messagecenter_reviews') .load('${pageContext.request.contextPath}/jsp/message_center/messagecenter_favorite.jsp');
		} else if (id == "4") {
			$('#messagecenter_reviews') .load('${pageContext.request.contextPath}/jsp/message_center/messagecenter_zan.jsp');
		}else{
			$('#messagecenter_reviews') .load('${pageContext.request.contextPath}/jsp/message_center/messagecenter_reviews.jsp');
		}
	}
        ...
        <div  id="messagecenter_label">
            	<ul>
                    ...
                    <div style=" cursor:pointer;position:relative;">
                    	<span id="message_pinglun">&emsp;&ensp;&emsp;评论消息&emsp;&ensp;&emsp;|</span><span  style="min-width: 20px;line-height:20px; text-align: center; position: absolute; background-color: #f00;  border-radius:15px; font-size:15px;color:#fff;width:10px;right:25px; top:5px; z-index:200;" ><%=comment_num %></span></div>
                    </li>
                    
                    <li>
                    <div style=" cursor:pointer;position:relative;">
                    	<span id="message_follow" >&emsp;&ensp;&emsp;关注消息&emsp;&ensp;&emsp;|</span><span  style="min-width: 20px;line-height:20px; text-align: center; position: absolute; background-color: #f00;  border-radius:15px; font-size:15px;color:#fff;width:10px;right:25px; top:5px; z-index:200;" ><%=follow_num %></span>
                    </div>
                    </li>
                    <li>
                    <div style="  cursor:pointer;position:relative;">
                    	<span  id="message_favorite">&emsp;&ensp;&emsp;收藏消息&emsp;&ensp;&emsp;|</span><span  style="min-width: 20px;line-height:20px; text-align: center; position: absolute; background-color: #f00;  border-radius:15px; font-size:15px;color:#fff;width:10px;right:25px; top:5px; z-index:200;" ><%=collect_num %></span>
                     </div>
                    </li>
                    <li>
                    <div style="  cursor:pointer;position:relative;">
                    	<span  id="message_zan">&emsp;&ensp;&emsp;点赞消息&emsp;&ensp;&emsp;</span><span  style="min-width: 20px;line-height:20px; text-align: center; position: absolute; background-color: #f00;  border-radius:15px; font-size:15px;color:#fff;width:10px;right:25px; top:5px; z-index:200;" ><%=zan_num %></span>
                    </div>
                    </li>
                </ul>
            </div>
