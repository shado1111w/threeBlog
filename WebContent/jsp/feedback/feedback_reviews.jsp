...
<div id="index_all">
	<div id="reportcenter_all">
        ...
        <span style="font-size:20px;">您要申请恢复是在博文&ensp;</span>
        ...
        <input type="text" style="width:800px; height:200px; border:1px solid;  color:#999; font-size:28px;" value="时间不在乎你拥有多少，而在乎你怎样使用！"/>
        </div>
