...
<div id="index_all">
	<div id="reportcenter_all">
        ...
        <span style="font-size:20px;">您要申请恢复是解除&ensp;</span>
        <a href="#"><u style="font-size:20px;color:#09F; font-weight:bold;">博文的发表和评论的发表</u></a>
        <span style="font-size:20px;">&ensp;摘要如下：&ensp;</span><br/><br/>
        <input type="text" style="width:800px; height:200px; border:1px solid;  color:#999; font-size:28px;" value="限制时间2018-05-01到2019-05-01"/>
        </div>
        
        <div  style="margin-left:100px;">
        <br/><br/>
        <span style="font-size:20px;">填写详细恢复说明：</span><br/><br/>
        <textarea style="width:800px; height:200px; border:1px solid;font-size:28px; resize:none;" placeholder="详细恢复理由"></textarea>
        </div>
